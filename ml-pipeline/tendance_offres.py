...
from config_seuils import SEUIL_TENDANCE, JOURS_MIN_FIABLE, VOLUME_MIN_FIABLE, NB_JOURS_COMPARAISON
...
def main():
    ...
    for offer_code, groupe in df.groupby("offer_code"):
        ...
        fiable = len(groupe) >= JOURS_MIN_FIABLE and volume_total >= VOLUME_MIN_FIABLE
