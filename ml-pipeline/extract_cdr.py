...
def calculer_error_description(df, error_dict):
    ...
    Version vectorisee (remplace l'ancien .apply() ligne par ligne, qui
    tournait sur les 4.4M lignes alors qu'il ne fait quelque chose que
    pour les ~570k transaction_failed).
    """
